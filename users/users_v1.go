...
func UsersListV1(ginctx *gin.Context) {
...
func CreateUserV1(ginctx *gin.Context) {
  // [START new_context]
  aectx := appengine.NewContext(ginctx.Request)
  // [END new_context]
...
func LoginUserV1(ginctx *gin.Context) {
  // [START new_context]
  aectx := appengine.NewContext(ginctx.Request)
  // [END new_context]
...
func PingUserV1(ginctx *gin.Context) {
  ginctx.String(http.StatusOK, "V1 pong")
}